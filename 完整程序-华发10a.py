...
# 重要参数
modelname = 'HUXW'
model_dir_path=r'D:\备份\华发10a\模型\备份旧模型'
# model_dir_path=r'D:\备份\华发10a\模型\方案意见试算202203月份'

# 不删除的文件名，查看盈建科程序打包文件，yjk 3.1.1版本

# savedFiles = [modelname+'.pre',modelname+'.rel',modelname+'.yjb',modelname+'.yjk',modelname+'.ymd',modelname+'_F.yjc']
savedFiles = [modelname+'.pre',modelname+'.rel',modelname+'.yjb',modelname+'.yjk',modelname+'.ymd',modelname+'_F.yjc']
